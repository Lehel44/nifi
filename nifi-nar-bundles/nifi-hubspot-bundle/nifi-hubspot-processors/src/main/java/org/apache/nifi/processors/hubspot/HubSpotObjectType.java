...
import static org.apache.nifi.processors.hubspot.IncrementalFieldType.CREATE_DATE;
import static org.apache.nifi.processors.hubspot.IncrementalFieldType.HS_CREATE_DATE;
...
public enum HubSpotObjectType implements DescribedValue {
    ...
    private final IncrementalFieldType createDateType;
    private final IncrementalFieldType lastModifiedDateType;

    HubSpotObjectType(String value, String displayName, String description, IncrementalFieldType createDateType, IncrementalFieldType lastModifiedDateType) {
        this.value = value;
    ...
    public IncrementalFieldType getCreateDateType() {
