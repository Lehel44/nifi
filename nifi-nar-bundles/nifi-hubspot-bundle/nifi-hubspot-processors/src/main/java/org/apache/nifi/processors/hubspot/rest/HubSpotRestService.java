 ...
 */
package org.apache.nifi.processors.hubspot.rest;
...
public class HubSpotRestService {
    ...
    public HubSpotRestService(final String version, final String baseUrl, final String accessToken, final String resourceName, final RestUriType restUriType,
    ...
    public InputStream getHubSpotObjects(final String fromDateTime) {
        String url = null;
