...
public class ResourceDirectory {
    ...
    static {
        ...
        resourceMap.put(ResourceType.COMPANIES, getCompanyResources());
    ...
    private static List<ShopifyResource> getCompanyResources() {
        final ShopifyResource allCompanies = ShopifyResource.withUriPath(
